...
DesignerTest.xcodeproj/project.pbxproj: DesignerTest.pro /usr/local/Qt-5.3.2/mkspecs/macx-clang/qmake.conf /usr/local/Qt-5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec macx-xcode -o DesignerTest.xcodeproj/project.pbxproj DesignerTest.pro
