#############################################################################
# Makefile for building: quit.app/Contents/MacOS/quit
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  quit.pro
# Template: app
# Command: /usr/local/Qt-5.3.2/bin/qmake -spec macx-xcode -o quit.xcodeproj/project.pbxproj quit.pro
#############################################################################

MAKEFILE      = project.pbxproj

QMAKE    = /usr/local/Qt-5.3.2/bin/qmake
quit.xcodeproj/project.pbxproj: quit.pro /usr/local/Qt-5.3.2/mkspecs/macx-clang/qmake.conf /usr/local/Qt-5.3.2/mkspecs/features/spec_pre.prf \
		...
		/usr/local/Qt-5.3.2/mkspecs/modules/qt_lib_enginio.pri \
		/usr/local/Qt-5.3.2/mkspecs/modules/qt_lib_enginio_private.pri \
		...
		/usr/local/Qt-5.3.2/mkspecs/modules/qt_lib_macextras.pri \
		/usr/local/Qt-5.3.2/mkspecs/modules/qt_lib_macextras_private.pri \
		...
		/usr/local/Qt-5.3.2/mkspecs/modules/qt_lib_webkit.pri \
		/usr/local/Qt-5.3.2/mkspecs/modules/qt_lib_webkit_private.pri \
		/usr/local/Qt-5.3.2/mkspecs/modules/qt_lib_webkitwidgets.pri \
		/usr/local/Qt-5.3.2/mkspecs/modules/qt_lib_webkitwidgets_private.pri \
	...
	$(QMAKE) -spec macx-xcode -o quit.xcodeproj/project.pbxproj quit.pro
