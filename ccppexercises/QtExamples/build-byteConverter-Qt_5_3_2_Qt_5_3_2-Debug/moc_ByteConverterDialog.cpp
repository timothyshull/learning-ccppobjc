...
#include "../byteConverter/ByteConverterDialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ByteConverterDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 43, 10)
    ...
    "ByteConverterDialog\0decChanged\0\0"
    "hexChanged\0binChanged"
};
...
const QMetaObject ByteConverterDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ByteConverterDialog.data,
      qt_meta_data_ByteConverterDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ByteConverterDialog.stringdata))
